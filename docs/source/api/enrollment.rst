...
+------------+----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ids        | const :ref:`JaniceTemplateIds`\* | An optional list of template ids that can be associated with the created templates for logging purposes. This parameter is set to :code:`nullptr` by default and is optional. If it is passed, it's length should be equal to :code:`media` and :code:`detections`.                                                                                                                                                                                                                                                          |
+------------+----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
